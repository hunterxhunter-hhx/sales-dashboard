...
assert "renderSegmentedReportHtml(channelRows" in weekly, "weekly channels should use the live/chase segmented renderer"
assert "renderSegmentedReportHtml(ownerRows" in weekly, "weekly owners should use the live/chase segmented renderer"
assert "showOrders: true" in weekly, "weekly channel/owner rows should allow order number expansion"

dimension_report = function_body("renderSegmentedReportHtml")
